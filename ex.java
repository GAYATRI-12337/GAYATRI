...
b=b.concat("sai");// hence it is immutable we can't change the value..
...
x.append("sai");
System.out.println("modified address : "+System.identityHashCode(x));//it is mutable we
can modify.
Integer original = 10;
System.out.println("Original address: " + System.identityHashCode(original)); // Print
original address
// Increment the value
Integer incremented = original + 1;
System.out.println("Incremented address: " + System.identityHashCode(incremented));
//Print incremented address
double a1=2.123;
